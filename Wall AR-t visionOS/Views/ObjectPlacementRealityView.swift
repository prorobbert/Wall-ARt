...
struct ObjectPlacementRealityView: View {
    ...
    @State private var collisionBeganSubscription: EventSubscription?
    @State private var collisionEndedSubscription: EventSubscription?
    ...
    var body: some View {
        RealityView { content, attachments in
            ...
            Attachment(id: Attachments.placementTooltip) {
                PlacementTooltip(
                    placementState: placementManager.placementState,
                    detectVerticalPlanes: appState.detectVerticalPlanes
                )
            }
