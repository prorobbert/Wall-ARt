...
public class AppState {
    ...
    private(set) public weak var placementManager: PlacementManager? = nil
    ...
    public static func previewAppState(immersiveSpaceOpened: Bool = false, selectedIndex: Int? = nil) -> AppState {
        ...
        state.setPlaceableObjects([previewObject(named: "pancakes", placeableOnPlane: .horizontal), previewObject(named: "retrotv", placeableOnPlane: .horizontal), previewObject(named: "KingFisherSplash", placeableOnPlane: .vertical), previewObject(named: "Statues", placeableOnPlane: .vertical)])
    ...
    private static func previewObject(named fileName: String, placeableOnPlane: PlaceablePlane) -> PlaceableObject {
        return PlaceableObject(descriptor: ModelDescriptor(fileName: fileName, placeableOnPlane: placeableOnPlane), previewEntity: ModelEntity(), renderContent: ModelEntity())
    }
}
